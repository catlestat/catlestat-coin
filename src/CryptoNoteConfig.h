...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = (unit64_t)(-1);
...
const char     CRYPTONOTE_NAME[]                             = "catlestatcoin";
...
const int      P2P_DEFAULT_PORT                              = 10013;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 10014;
